...
function nm({ bestScore: g }) {
  return g
    ? X.jsxs("div", {
        className: "personal-best-badge",
        children: [
          X.jsx("img", { src: um, alt: "", width: "20", height: "18" }),
          X.jsxs("span", {
...
const im = "" + new URL("logo-large-DQpruBTa.svg", import.meta.url).href,
  cm =
...
function fm({ bestScore: g }) {
  return X.jsxs("header", {
    className: "app-header",
    children: [
      X.jsxs("picture", {
        children: [
          X.jsx("source", { srcSet: im, media: "(min-width: 600px)" }),
          X.jsx("img", { className: "header-logo", src: cm, alt: "Typed", height: "32" }),
        ],
      }),
      X.jsx(nm, { bestScore: g }),
    ],
  });
}
function sm() {
...
function dm({ difficulty: g, onChange: R, disabled: N }) {
  return X.jsx("div", {
...
function ym({ mode: g, onChange: R, disabled: N }) {
  return X.jsx("div", {
...
function mm({ difficulty: g, mode: R, onDifficultyChange: N, onModeChange: h, disabled: q }) {
  return X.jsxs("div", {
    className: "controls",
    children: [
      X.jsx(sm, {}),
      X.jsx(dm, { difficulty: g, onChange: N, disabled: q }),
      X.jsx(ym, { mode: R, onChange: h, disabled: q }),
    ],
  });
}
...
function bm() {
  return pu.useReducer(Sm, Ad);
}
const pm = "typing-speed-best";
function zm() {
  const [g, R] = pu.useState(null);
  return (
    pu.useEffect(() => {
      try {
        const N = localStorage.getItem(pm);
        N && R(JSON.parse(N));
      } catch {}
    }, []),
    g
